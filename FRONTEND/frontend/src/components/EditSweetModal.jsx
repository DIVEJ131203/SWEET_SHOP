...
const EditSweetModal = ({ sweet, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/sweets/${sweet._id}`, {
        method: 'PUT',
        headers: {
      ...
      alert(error.message || 'Failed to update sweet');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {/* Current Image */}
            {(sweet.imageUrl || sweet.imageFromUrl) && !selectedFile && !imagePreview && (
              <div className="mb-3">
                <label className="block text-xs text-gray-600 mb-1">Current Image</label>
                <img
            ...
            {/* Image Preview */}
            {(imagePreview || (formData.imageUrl && formData.imageUrl !== (sweet.imageFromUrl || ''))) && (
              <div className="mt-2">
                <img
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setImagePreview('');
                    setFormData({ ...formData, imageUrl: sweet.imageFromUrl || '' });
                  }}
